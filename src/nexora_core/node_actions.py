...
try:
    ...
    docker_compose_up = None  # type: ignore[assignment]
    write_compose_file = None  # type: ignore[assignment]

try:
    from .failover import apply_maintenance_mode, remove_maintenance_mode
except ImportError:  # pragma: no cover
    apply_maintenance_mode = None  # type: ignore[assignment]
    remove_maintenance_mode = None  # type: ignore[assignment]

try:
    from .governance import executive_report
except ImportError:  # pragma: no cover
    executive_report = None  # type: ignore[assignment]

try:
    from .pra import build_restore_plan
except ImportError:  # pragma: no cover
    build_restore_plan = None  # type: ignore[assignment]

try:
    from .privileged_actions import build_privileged_execution_plan
except ImportError:  # pragma: no cover
    build_privileged_execution_plan = None  # type: ignore[assignment]

try:
    from .sync import detect_sync_conflicts
except ImportError:  # pragma: no cover
    detect_sync_conflicts = None  # type: ignore[assignment]
...
def run_healthcheck(
    ...
    dashboard = service.dashboard().model_dump()
