...
def register_edge_tools(mcp: FastMCP, settings=None):
    ...
    @mcp.tool()
    async def ynh_edge_generate_nginx_lb(domain: str, backends: str, mode: str = "round_robin") -> str:
        ...
        """
        from nexora_node_sdk.edge import generate_nginx_lb_config
    ...
    async def ynh_edge_generate_haproxy(backends: str, mode: str = "roundrobin") -> str:
        ...
        """
        from nexora_node_sdk.edge import generate_haproxy_config
    ...
    @mcp.tool()
    async def ynh_edge_dns_failover(domain: str, primary_ip: str, secondary_ip: str) -> str:
        ...
        """
        from nexora_node_sdk.edge import generate_dns_failover
    ...
    @mcp.tool()
    async def ynh_edge_maintenance_mode(domain: str, message: str = "Maintenance en cours") -> str:
        """Génère une configuration de mode maintenance pour un domaine.
        Args:
            domain: Domaine à mettre en maintenance
            message: Message à afficher
        """
        from nexora_node_sdk.edge import generate_maintenance_config
    ...
    async def ynh_edge_network_map() -> str:
        ...
        from nexora_node_sdk.edge import generate_network_map
    ...
    @mcp.tool()
    async def ynh_edge_apply_nginx_lb(domain: str, backends: str, mode: str = "round_robin") -> str:
        ...
        Args:
            ...
            mode: Algorithme (round_robin, least_conn, ip_hash)
        """
        from nexora_node_sdk.edge import apply_nginx_lb, generate_nginx_lb_config
